...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 0 Preflight | `pytest tests/unit -q` | dev/`80dc069` (AM) | n/a | n/a | n/a | 1385 pass / 3 fail / 1 skip | contractor-overlay-drift (the `model_registry.local.yaml` false alarm), no code regression |
