...
No gate was bypassed. Pre-commit passed the contract validation, substance, AC-binding, receipt-hardening, yamlfmt, and no-AI-attribution gates. The three PASS receipts are recorded from the measured focused runs and CI re-verifies them.

Evidence-Source: OCC#10675
Evidence-Ticket: OMN-18082
